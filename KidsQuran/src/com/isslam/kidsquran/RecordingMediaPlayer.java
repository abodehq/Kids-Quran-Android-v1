...
public class RecordingMediaPlayer implements OnCompletionListener {
	...
	private static RecordingMediaPlayer instance = null;
	private Context context;

	public static RecordingMediaPlayer getInstance(Context _context) {
		if (instance == null) {
			instance = new RecordingMediaPlayer(_context);
		}
		return instance;
	}

	public RecordingMediaPlayer(Context _context) {
		context = _context;
		CreateMediaPlayer();
		setList();
	...
	public class LocalBinder extends Binder {
		public RecordingMediaPlayer getService() {
			return RecordingMediaPlayer.this;
		}
	}
