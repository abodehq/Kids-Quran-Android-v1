...
public class NoRecitersFragment extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.ly_no_reciters, container, false);
		...
		btn_accept.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				i.setClass(getDialog().getContext(), RecitersActivity.class);
				startActivity(i);
				getDialog().cancel();
				getActivity().finish();
